...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.model = [
            ...
            // },
            // {
            //     label: 'attendance', icon: 'pi pi-fw pi-file', routerLink: ['/attendance']
            // },
            // {
            //     label: 'job-board', icon: 'pi pi-fw pi-file', routerLink: ['/job-board']
            // },
            {
                label: 'Oportunidades', icon: 'pi pi-fw pi-money-bill', routerLink: ['/job-board/oportunidades']
            }
        ];
